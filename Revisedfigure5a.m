...
figure;plot([101:6590+100]*0.5,2.4*4*10^8/400*seismogramVz(101:end)/10^5/2.5+1.5,'r')
load('NonbalancedSmallGridBoundary29Hz.mat')
hold on;plot([101:6590+100]*0.5,2.4*4*10^8/400*seismogramVz(101:end)/10^5/2.5+1.5,'k')
...
hold on;plot([101:6590+100]*0.5,2.4*4*10^8/400*seismogramVz6(101:end)/10^5/2.5-0.25,'r')
...
hold on;plot([101:6590+100]*0.5,2.4*4*10^8/400*seismogramVz6(101:end)/10^5/2.5-0.25,'k')
